...
<div class="container">
    ...
    <form action="/QLY_PHONG_TRO/ThuePhongServlet" method="post">
        <input type="hidden" name="action" value="add">
        <table>
            <tr>
                <td align="right">Mã Thuê:</td>
                <td><input type="text" name="MaThue" required></td>
            </tr>
            <tr>
                <td align="right">Mã CCCD:</td>
            ...
            <tr>
                <td align="right">Ngày Thuê:</td>
                <td><input type="date" name="NgayThue" required></td>
            </tr>
            <tr>
                <td align="right">Ngày Hết Hạn Thuê:</td>
                <td><input type="date" name="NgayHetHanThue" required></td>
            </tr>            
        </table>
